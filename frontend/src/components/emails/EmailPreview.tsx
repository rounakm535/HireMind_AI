  ...
  return (
    <div className="bg-white border border-slate-100 rounded-2xl shadow-sm overflow-hidden font-sans">
      ...
      <div className="p-6 space-y-4">
        {/* Recipient */}
        <div className="grid grid-cols-[80px_1fr] items-center text-[12px] border-b border-slate-50 pb-3">
        ...
        <div className="pt-2">
          <textarea
            readOnly
            value={email.body}
            className="w-full text-[13px] text-slate-600 border border-transparent bg-slate-50/50 rounded-xl p-4 h-64 focus:outline-none select-text resize-none leading-relaxed font-medium"
          />
        </div>
      </div>
    </div>
